local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Cauze/awesome-roblox-uis/refs/heads/main/collection/known/bitchbot-v1/source.lua"))()
