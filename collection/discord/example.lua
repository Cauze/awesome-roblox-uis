...
local DiscordLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawid-scripts/UI-Libs/refs/heads/main/discord%20lib.txt"))()

local Window = DiscordLib:Window("My Script")

local Server1 = Window:Server("Main Server", "")
local Channel1 = Server1:Channel("General")

Channel1:Button("Execute", function()
    print("Button clicked!")
end)

Channel1:Toggle("Enable Feature", false, function(state)
    print("Toggle:", state)
end)

Channel1:Slider("Speed", 0, 100, 50, function(value)
    print("Speed:", value)
end)

Channel1:Dropdown("Option", {"Option 1", "Option 2", "Option 3"}, function(selected)
    print("Selected:", selected)
end)

Channel1:Colorpicker("Theme Color", Color3.fromRGB(114, 137, 228), function(color)
    print("Color:", color)
end)

Channel1:Textbox("Username", "Enter name...", true, function(text)
    print("Username:", text)
end)

Channel1:Label("This is a label")

Channel1:Bind("Toggle UI", Enum.KeyCode.F, function()
    print("Bind triggered!")
end)

Channel1:Seperator()

DiscordLib:Notification("Welcome!", "Thanks for using Discord Lib!", "OK")
]]
